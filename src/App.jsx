...
function App() {
  ...
  return (
    <div className="app">
      ...
      {/* Menu Section */}
      <section id="menu" className="section bg-light">
        <div className="container">
          <h2 className="section-title">Especialidades del Día</h2>
          
          <div className="menu-grid">
            {/* Category: Panes y Catalinas */}
            <div className="menu-category card-premium">
              <div className="category-header">
                <div className="category-image">
                  <img src="/products/varied_breads.png" alt="Panes Artesanales" />
                </div>
                <div className="category-info">
                  <h3>Panes & Catalinas</h3>
                  <div className="pricing-badge">
                    <div className="price-item">
                      <span className="label">Unidad</span>
                      <span className="value">S/ 6.00</span>
                    </div>
                    <div className="price-divider"></div>
                    <div className="price-item">
                      <span className="label">10+ Und.</span>
                      <span className="value">S/ 4.50</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="category-body">
                <ul className="product-list-fancy">
                  <li><span>Pan de guayaba</span></li>
                  <li><span>Pan queso</span></li>
                  <li><span>Pan de guayaba con queso</span></li>
                  <li><span>Pan de queso con tocineta</span></li>
                  <li><span>Pan de manjar</span></li>
            ...
            <div className="menu-category card-premium">
              <div className="category-header">
                <div className="category-image">
                  <img src="/products/quesadillas.png" alt="Quesadillas" />
                </div>
                <div className="category-info">
                  <h3>Quesadillas</h3>
                  <div className="pricing-badge highlight">
                    <div className="price-item">
                      <span className="label">Unidad</span>
                      <span className="value">S/ 4.00</span>
                    </div>
                    <div className="price-divider"></div>
                    <div className="price-item">
                      <span className="label">10+ Und.</span>
                      <span className="value">S/ 2.50</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="menu-category card-premium">
              <div className="category-header">
                <div className="category-image">
                  <img src="/products/golfiados.png" alt="Golfiados" />
                </div>
                <div className="category-info">
                  <h3>Golfiados</h3>
                  <div className="pricing-badge">
